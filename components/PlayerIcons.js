...
export function SkipBackIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function SkipForwardIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M13 12l-8 6V6z" />
      <path d="M21 12l-8 6V6z" />
    </svg>
  );
}

export function CloseIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M5 5l14 14" />
...
export function TeamIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <circle cx="8.5" cy="8" r="3" />
      <path d="M2.5 19c1.1-3 3.2-4.7 6-4.7s4.9 1.7 6 4.7" />
      <circle cx="17" cy="8.5" r="2.5" />
      <path d="M15.5 14.5c2.2.3 3.7 1.8 4.6 4.5" />
    </svg>
  );
}

export function TvIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <rect x="2.5" y="5.5" width="19" height="13" rx="2" />
...
export function LiveDotIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function AntennaIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M12 21V10" />
      <path d="M12 10l6-7" />
      <path d="M12 10L6 3" />
      <path d="M8.5 6.5l-2 -2.3" />
      <path d="M15.5 6.5l2 -2.3" />
    </svg>
  );
}

export function InboxIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M3 12h5l1.5 3h5L16 12h5" />
      <rect x="3" y="12" width="18" height="8" rx="1.5" />
      <path d="M3 12l2.5-7.5A1.5 1.5 0 0 1 6.9 3.5h10.2a1.5 1.5 0 0 1 1.4 1L21 12" />
    </svg>
  );
}

export function ImageIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function SlidersIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function CalendarIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function PaletteIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M12 3a9 9 0 1 0 0 18c1.2 0 2-1 2-2 0-.6-.2-1-.5-1.3-.3-.4-.5-.8-.5-1.2 0-1 .8-1.5 1.8-1.5H17a4 4 0 0 0 4-4c0-4.4-4-8-9-8z" />
...
export function HeadphonesIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function ChatIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function TrashIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M4 7h16" />
...
export function WarningIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function ClockIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function PencilIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function EyeIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function UndoIcon({ src, size = 18 }) {
  if (src) return <IconImage src={src} size={size} />;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
