...
export const SITE = {
  ...
  // The paid membership tier. Previously "Cipher Circle" — renamed, and
  // centralized here for the same reason the platform name was: so this
  // never again needs finding across two dozen files by hand.
  premiumTier: 'Studio Tapa +',
