...
// A longer, spelled-out duration for hero/banner display ("1h 3m 5s",
// "3m 5s", "45s") — distinct from formatRuntime's compact "1:03:05" used
// on library cards and episode rows, where space is tight. Takes the same
// runtime string every episode already stores, so no new field is needed;
// this just renders the existing value differently in one specific place.
// Omits leading zero-value units rather than padding them, since "0h 3m"
// reads worse than just "3m".
