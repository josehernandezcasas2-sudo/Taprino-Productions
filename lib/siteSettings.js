...
export async function getSiteSettings() {
  ...
  if (error) {
    ...
    return { shopEnabled: false, shopUrl: null, liveTvEnabled: true, verticalEnabled: true, podcastsEnabled: true, searchIconUrl: null, recommendationCloseness: 6, elevatorPitchEnabled: false, themeOverrides: {} };
  }
  return {
