...
export async function addEpisodeToSchedule(episodeId) {
  ...
  if (episode.tier !== 'free') throw new Error('Only free-tier episodes can go on the channel — Cipher Circle content stays behind the paywall everywhere, including here.');
