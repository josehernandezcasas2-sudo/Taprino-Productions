...
export const PLAYER_ICON_KEYS = [
  ...
  'tab_home', 'tab_watch', 'tab_discover', 'tab_account', 'skip_back', 'skip_forward', 'close',
  'team', 'tv', 'live_dot', 'antenna', 'inbox', 'image', 'sliders', 'calendar', 'palette',
  'headphones', 'chat', 'trash', 'warning', 'clock', 'pencil', 'eye', 'undo', 'external_link', 'link', 'ticket', 'browser_tab'
];
