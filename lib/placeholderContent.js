...
function svgThumbnail(label, sublabel, color) {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="640" height="360" viewBox="0 0 640 360">
    ...
    <text x="320" y="175" font-family="Georgia, serif" font-size="34" font-weight="bold" fill="#fbe8d3" text-anchor="middle">${label}</text>
    <text x="320" y="205" font-family="monospace" font-size="15" letter-spacing="2" fill="#fbe8d3" opacity="0.75" text-anchor="middle">${sublabel}</text>
  </svg>`;
