  ...
  const enriched = await Promise.all(
    (data || []).map(async (ep) => {
      ...
      return {
        ...
        rating: ep.rating || '',
        adBreakSeconds: ep.ad_break_seconds,
        availableFrom: ep.available_from,
        availableUntil: ep.available_until,
        bonusParentType: ep.bonus_parent_type,
        bonusParentId: ep.bonus_parent_id,
