...
const EDITABLE_FIELDS = ['title', 'description', 'artist', 'runtime', 'genre', 'mainGenre', 'tier', 'status', 'featured', 'availableFrom', 'availableUntil', 'adsEnabled', 'contentType', 'seriesId', 'season', 'seriesOrder', 'rating', 'isOriginal', 'fundingUrl', 'audioUrl'];
const FIELD_TO_COLUMN = { mainGenre: 'main_genre', availableFrom: 'available_from', availableUntil: 'available_until', adsEnabled: 'ads_enabled', contentType: 'content_type', seriesId: 'series_id', seriesOrder: 'series_order', isOriginal: 'is_original', fundingUrl: 'funding_url', audioUrl: 'audio_url' };
...
export default async function handler(req, res) {
  ...
  if ((fields.contentType === 'series' || fields.contentType === 'podcast') && !fields.seriesId) {
